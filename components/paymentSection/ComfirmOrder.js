...
const ComfirmOrder = ({ tempProductdata }) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex mt-7 items-center justify-start flex-col space-y-7 space-x-0 lg:flex-row lg:space-x-7 lg:space-y-0 lg:justify-between">
            ...
            <div className="flex items-center justify-center">
              <Button
                ...
                className={`bg-App_green_L hover:bg-App_green_D transition-all duration-200 ease-out mt-4 w-[80%] h-12 text-lg ${
                  loading && "!bg-App_green_D pointer-events-none"
                }`}
